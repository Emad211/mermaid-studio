    ...
    graph.push({
      ...
      mainEntity: {
        ...
        itemListElement: [
          ...
          "Git Flow برای feature، release و hotfix",
          "System Context سامانهٔ انتشار محتوا",
          "معماری سرویس انتشار محتوا",
          "مصرف فضای Repository براساس بخش",
          "هدر بستهٔ تله‌متری ۱۲۰ بیتی",
          "جریان کاربران از آموزش تا خروجی",
          "تحلیل علت شکست انتشار نسخه",
          "ماتریس اثر و تلاش Backlog محصول",
          "رسیدگی و ارجاع تیکت پشتیبانی",
          "آمادگی انتشار در برابر آستانه",
          "ترکیب ظرفیت Sprint",
